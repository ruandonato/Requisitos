...
story_list.each do |role,action,reason,status,estimate,acceptance,observations,task,release|
  description = "Eu, como " + role + ", desejo " + action + " para " + reason
  Story.create(role: role, action: action, reason: reason, description: description, status: status, estimate: estimate, acceptance: acceptance, observations: observations, task: task, release: release, project_id: 1)
end

story_list_second.each do |role,action,reason,status,estimate,acceptance,observations,task,release|
  description = "Eu, como " + role + ", desejo " + action + " para " + reason
  Story.create(role: role, action: action, reason: reason, description: description, status: status, estimate: estimate, acceptance: acceptance, observations: observations, task: task, release: release, project_id: 2)
end

story_list_third.each do |role,action,reason,status,estimate,acceptance,observations,task,release|
  description = "Eu, como " + role + ", desejo " + action + " para " + reason
  Story.create(role: role, action: action, reason: reason, description: description, status: status, estimate: estimate, acceptance: acceptance, observations: observations, task: task, release: release, project_id: 3)
end

story_list_forth.each do |role,action,reason,status,estimate,acceptance,observations,task,release|
  description = "Eu, como " + role + ", desejo " + action + " para " + reason
  Story.create(role: role, action: action, reason: reason, description: description, status: status, estimate: estimate, acceptance: acceptance, observations: observations, task: task, release: release, project_id: 4)
end